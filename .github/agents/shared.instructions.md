---
description: "Shared rules for all agents in the Ontology to Accelerator migration project. USE FOR: enforcing project-wide constraints, coding standards, and safety rules."
---

# Shared Project Rules — Ontology to Accelerator Migration
