...
const STATUS_COLORS: Record<TurbineStatus, string> = {
    healthy: "#58d68d",
    warning: "#ffd166",
    alarm: "#ef476f",
};
...
function createMapTexture(sites: WindSite[]) {
                    ...
                    {view === "map" && (
                        <div className="relative h-full min-h-[520px]">
                            ...
                            <div className="absolute bottom-3 left-3 rounded-lg border border-slate-700/60 bg-[#06101fcc] px-3 py-1.5 text-xs text-slate-400">
                                Click any turbine to open its live detail popup · scroll or use ＋ / － to zoom.
                            </div>
                        </div>
                    )}
                            ...
                            <div className="grid grid-cols-1 gap-3 xl:grid-cols-3">
                                <div className="flex flex-col gap-3 xl:col-span-2">
                                    ...
                                    <div className="relative h-[480px] overflow-hidden rounded-xl border border-slate-700/60 bg-[#051020]">
                                        <TurbineTwinScene turbine={selected} paused={!live} />
                        ...
                        <div className="h-full overflow-y-auto p-4">
                            <div className="grid grid-cols-1 gap-3 lg:grid-cols-2">
                                ...
                                <Panel title="Anomaly watch (predictive)">
                                    <p className="mb-2 text-[11px] text-slate-400">Turbines trending toward thresholds, ranked by anomaly score from nacelle temp & vibration.</p>
                                    <ul className="space-y-2">
                                        {anomalyWatch.map((a) => (
                                            <li key={a.t.id}>
                                                <div className="flex justify-between text-xs">
