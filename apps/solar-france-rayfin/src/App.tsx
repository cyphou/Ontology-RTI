...
export function classifyAskIntent(question: string): AskIntent {
    ...
    const opsPatterns = [
        ...
        /\b(hottest|temperature|temp|module|inverter|irradiance|output|throughput|utilization|feed)\b/,
                    ...
                    {view === "map" && (
                        <div className="relative h-full min-h-[420px] md:min-h-[520px]">
                            ...
                            <div className="absolute bottom-3 left-3 hidden rounded-lg border border-slate-700/60 bg-[#06101fcc] px-3 py-1.5 text-xs text-slate-400 sm:block">
                                Click any plant to open its live detail popup · scroll or use ＋ / － to zoom.
                            </div>
                        </div>
                    )}
