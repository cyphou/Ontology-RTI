...
// the process-unit structures. Positioned in world space, it pans/zooms with the map.
...
// World height for the floating site labels — clearly above the refinery structures.
